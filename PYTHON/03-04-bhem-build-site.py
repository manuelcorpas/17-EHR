#!/usr/bin/env python3
"""
03-04-bhem-build-site.py
========================
HEIM-Biobank v2.0 (IHCC): Build Static Dashboard Site
...
USAGE:
    python 03-04-bhem-build-site.py
...
<head>
    ...
    <title>HEIM-Biobank v2.0 (IHCC) | Global Equity Index for Biobank Research</title>
...
<body>
    ...
    <header class="header">
        <div class="header-content">
            <div class="header-title">
                <h1>HEIM-Biobank <span class="version">v2.0</span></h1>
    ...
    <main class="main-content">
        ...
        <section id="about" class="tab-content">
            <div class="section-header">
                <h2>About HEIM-Biobank</h2>
                <p>Methodology, data sources, and how to interpret this dashboard</p>
            </div>
            
            <!-- What is HEIM-Biobank -->
            <div class="card methodology-card">
                <h3>🎯 What is HEIM-Biobank?</h3>
                <p><strong>HEIM-Biobank</strong> (Health Equity Informative Metrics for Biobanks) is a tool that measures how well biobank research aligns with global health priorities. It answers a critical question: <em>Are biobanks studying the diseases that cause the most suffering worldwide?</em></p>
                <p>Many biobanks are located in high-income countries and tend to focus on diseases prevalent in those regions. Meanwhile, conditions like malaria, tuberculosis, and diarrheal diseases—which cause enormous suffering in low- and middle-income countries—receive relatively little attention. HEIM-Biobank quantifies these gaps to guide more equitable research priorities.</p>
            </div>
            ...
            <div class="card methodology-card">
                ...
                <div class="methodology-subsection">
                    <h4>Global Burden of Disease (GBD) 2021</h4>
                    <p>Disease burden data comes from the <a href="https://www.healthdata.org/gbd/2021" target="_blank">Global Burden of Disease Study 2021</a>, published by the Institute for Health Metrics and Evaluation (IHME). This is the world's most comprehensive effort to measure health loss from diseases, injuries, and risk factors.</p>
                    <ul>
                        <li><strong>DALYs (Disability-Adjusted Life Years)</strong>: The primary measure of disease burden. One DALY = one year of healthy life lost, either through premature death or living with disability.</li>
                        <li><strong>179 disease causes</strong> are analyzed, organized into categories (e.g., Cardiovascular, Infectious, Neurological).</li>
                        <li><strong>Global estimates</strong> are used to represent worldwide health priorities.</li>
                    </ul>
                </div>
                
                <div class="methodology-subsection">
                    <h4>PubMed / MEDLINE</h4>
                    <p>Publication data is retrieved from <a href="https://pubmed.ncbi.nlm.nih.gov/" target="_blank">PubMed</a>, the largest database of biomedical literature. Publications are:</p>
                    <ul>
                        <li>Retrieved using biobank-specific search queries</li>
                        <li>Mapped to GBD disease categories using MeSH (Medical Subject Headings) terms</li>
                        <li>Filtered to include only peer-reviewed articles (preprints excluded)</li>
                    </ul>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Biobank Registry</h4>
                    <p>The dashboard currently includes <strong>27 major biobanks</strong> worldwide, classified by:</p>
                    <ul>
                        <li><strong>WHO Region</strong>: AFR (Africa), AMR (Americas), EMR (Eastern Mediterranean), EUR (Europe), SEAR (South-East Asia), WPR (Western Pacific)</li>
                        <li><strong>Income Status</strong>: High-Income Countries (HIC) vs Low/Middle-Income Countries (LMIC)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card methodology-card">
                ...
                <div class="methodology-subsection">
                    <h4>Equity Alignment Score (EAS)</h4>
                    <p>A score from 0-100 measuring how well a biobank's research output matches global disease burden. <strong>Higher is better.</strong></p>
                    <div class="formula-box">
                        <code>EAS = 100 - (0.4 × Gap_Severity + 0.3 × Burden_Miss + 0.3 × Capacity_Penalty)</code>
                    </div>
                    <ul>
                        <li><strong>Strong (≥70)</strong>: Research well-aligned with global health priorities</li>
                        <li><strong>Moderate (50-69)</strong>: Some alignment, room for improvement</li>
                        <li><strong>Weak (30-49)</strong>: Significant gaps in priority disease coverage</li>
                        <li><strong>Poor (&lt;30)</strong>: Research focus misaligned with global burden</li>
                    </ul>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Research Gap Score</h4>
                    <p>A score from 0-100 for each disease measuring the mismatch between disease burden and research attention. <strong>Higher = bigger gap (worse).</strong></p>
                    <ul>
                        <li><strong>Critical (&gt;70)</strong>: Severely under-researched relative to burden</li>
                        <li><strong>High (50-70)</strong>: Substantially under-researched</li>
                        <li><strong>Moderate (30-50)</strong>: Moderately under-researched</li>
                        <li><strong>Low (&lt;30)</strong>: Research roughly proportional to burden</li>
                    </ul>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Research Opportunity Score (ROS)</h4>
                    <p>For each biobank, this represents the cumulative disease burden of conditions with minimal research coverage (≤2 publications). A <strong>higher ROS</strong> indicates more untapped potential for impactful research.</p>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Equity Ratio</h4>
                    <p>Compares research intensity between high-income and low/middle-income country biobanks:</p>
                    <div class="formula-box">
                        <code>Equity Ratio = (Pubs_HIC / DALYs_HIC) / (Pubs_LMIC / DALYs_LMIC)</code>
                    </div>
                    <p>A ratio of 1.0 would indicate equal research intensity. Ratios &gt;100 indicate severe imbalance favoring HIC research.</p>
                </div>
            </div>
            ...
            <div class="card methodology-card">
                ...
                <div class="methodology-subsection">
                    <h4>Overview Tab</h4>
                    <p>Start here for a global summary: total biobanks analyzed, publications mapped, and critical research gaps across all diseases.</p>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Biobanks Tab</h4>
                    <p>Explore individual biobank performance. Filter by region or equity category. Click column headers to sort.</p>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Diseases Tab</h4>
                    <p>See which diseases are under-researched. Filter by category or gap severity. High-burden diseases with few publications represent urgent priorities.</p>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Matrix Tab</h4>
                    <p>Visualize the intersection of biobanks and diseases. Darker cells = more publications. Gaps (empty cells) reveal opportunities.</p>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Trends Tab</h4>
                    <p>Track publication growth over time by biobank. Identifies which resources are expanding most rapidly.</p>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Themes Tab</h4>
                    <p>Understand research themes based on MeSH term clustering. See which methodological approaches (GWAS, imaging, etc.) dominate.</p>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Compare Tab</h4>
                    <p>Side-by-side comparison of any two biobanks across multiple dimensions.</p>
                </div>
                
                <div class="methodology-subsection">
                    <h4>Equity Tab</h4>
                    <p>Deep dive into HIC vs LMIC disparities. See Global South priority diseases and regional publication distribution.</p>
                </div>
            </div>
            ...
            <div class="card methodology-card">
                ...
                <table class="glossary-table">
                    <tr>
                        <td><strong>Biobank</strong></td>
                        <td>A repository that stores biological samples (blood, tissue, DNA) linked to health records for research.</td>
                    </tr>
                    <tr>
                        <td><strong>DALYs</strong></td>
                        <td>Disability-Adjusted Life Years. Combines years of life lost (mortality) and years lived with disability (morbidity) into a single measure.</td>
                    </tr>
                    <tr>
                        <td><strong>GBD</strong></td>
                        <td>Global Burden of Disease Study. A comprehensive assessment of mortality and disability from major diseases worldwide.</td>
                    </tr>
                    <tr>
                        <td><strong>HIC</strong></td>
                        <td>High-Income Countries. Nations with high gross national income per capita (e.g., USA, UK, most of Europe).</td>
                    </tr>
                    <tr>
                        <td><strong>LMIC</strong></td>
                        <td>Low- and Middle-Income Countries. Nations with lower gross national income (e.g., most of Africa, South Asia, Latin America).</td>
                    </tr>
                    <tr>
                        <td><strong>MeSH</strong></td>
                        <td>Medical Subject Headings. A controlled vocabulary used to index biomedical literature in PubMed.</td>
                    </tr>
                    <tr>
                        <td><strong>WHO Region</strong></td>
                        <td>Geographic regions defined by the World Health Organization: AFR, AMR, EMR, EUR, SEAR, WPR.</td>
                    </tr>
                    <tr>
                        <td><strong>Global South</strong></td>
                        <td>Term referring to countries in Africa, Latin America, Asia, and Oceania that are generally lower-income and bear disproportionate disease burden.</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="card methodology-card">
                <h3>📚 Citation</h3>
                <p>This dashboard implements the methodology described in:</p>
                <div class="citation-box">
                    <p><strong>Corpas M, Ojewunmi O, Guio H, Fatumo S.</strong> (2025). EHR-Linked Biobank Expansion Reveals Global Health Inequities. <em>Annual Review of Biomedical Data Science</em>.</p>
                </div>
                <p>Source code and data: <a href="https://github.com/manuelcorpas/17-EHR" target="_blank">https://github.com/manuelcorpas/17-EHR</a></p>
            </div>
            
            <!-- Contact -->
            <div class="card methodology-card">
                <h3>📧 Contact</h3>
                <p>For questions, suggestions, or to request addition of new biobanks:</p>
                <p><strong>Manuel Corpas</strong> — <a href="mailto:m.corpas@westminster.ac.uk">m.corpas@westminster.ac.uk</a></p>
                <p>University of Westminster | The Alan Turing Institute | Cambridge Precision Medicine</p>
            </div>
        </section>
    ...
    <footer class="footer">
        <div class="footer-content">
            <p>
                <strong>HEIM-Biobank v2.0 (IHCC)</strong> | 
...
CSS_TEMPLATE = '''/* HEIM-Biobank v2.0 (IHCC) Dashboard Styles */
...
APP_JS_TEMPLATE = '''// HEIM-Biobank v2.0 (IHCC) Dashboard Application
...
CHARTS_JS_TEMPLATE = '''// HEIM-Biobank v2.0 (IHCC) Chart Visualizations
...
def main():
    print("=" * 70)
    print(f"HEIM-Biobank v2.0 (IHCC): Build Static Dashboard Site")
    print("=" * 70)
